...
blob_fixups: blob_fixups_user_type = {
    ...
    .replace_needed(
        ...
        "lib_android_keymaster_keymint_utils-vendorcompat.so",
    )
    .replace_needed(
        "libkeymint.so",
        "libkeymint-vendorcompat.so",
    )
    .add_needed("android.hardware.security.rkp-V3-ndk.so"),
    "vendor/lib64/lib_android_keymaster_keymint_utils-vendorcompat.so": blob_fixup()
    .patchelf_version(patchelf_version)
    .replace_needed(
        "android.hardware.security.keymint-V1-ndk_platform.so",
        "android.hardware.security.keymint-V4-ndk.so",
    ),
    "vendor/lib64/libkeymint-vendorcompat.so": blob_fixup()
    .patchelf_version(patchelf_version)
    .replace_needed(
        "android.hardware.security.keymint-V1-ndk_platform.so",
        "android.hardware.security.keymint-V4-ndk.so",
    ...
    .add_needed("android.hardware.security.rkp-V3-ndk.so")
    .add_needed("libandroidkeymaster_abi_shim.so"),
    "vendor/lib64/libkeymint_support-vendorcompat.so": blob_fixup()
    .patchelf_version(patchelf_version)
    .replace_needed(
        "android.hardware.security.keymint-V1-ndk_platform.so",
        "android.hardware.security.keymint-V4-ndk.so",
    ...
    .replace_needed(
        ...
        "libkeymint_support-vendorcompat.so",
    ),
    "vendor/etc/init/android.hardware.gatekeeper@1.0-service-vendorcompat.rc": blob_fixup().regex_replace(
        "android.hardware.gatekeeper@1.0-service",
        "android.hardware.gatekeeper@1.0-service-vendorcompat",
    ),
